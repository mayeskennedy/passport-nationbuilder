...
function Strategy(options, verify) {
  options = options || {};
  if (!options.slug) throw new TypeError('NationBuilder requires slug');

  options.authorizationURL = options.authorizationURL || 'https://' + options.slug + '.nationbuilder.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://' + options.slug + '.nationbuilder.com/oauth/token';
  ...
  this._profileURL = options.profileURL || 'https://foobar.nationbuilder.com/api/v1/people/me';
}
